...
from src.creditcardDefault.utils.common import save_object
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        '''
        try:
            numerical_columns = ['LIMIT_BAL' ,'AGE', 'PAY_0', 'PAY_2', 'PAY_3', 'PAY_4', 'PAY_5', 'PAY_6', 'TOTAL_BILL_AMT', 'TOTAL_PAY_AMT'
                                 ]
